...
_nota:_ gli eventi indiiduati non sono mutuamente esclusivi, un doubleTap è di fatto due singleTap $\rightarrow$ l'API ci fornirà strumenti per gestire questo.  
