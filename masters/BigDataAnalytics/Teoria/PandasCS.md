...
6. Conta il numero di elementi in una colonna 
...
La clausola `groupby` permette di raggruppare i dati secondo specifi criteri (per singolo gruppo o per gruppi).  
